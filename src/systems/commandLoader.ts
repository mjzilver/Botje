...
function loadCommandsFromDir<T extends ICommand | IClCommand>(dirPath: string, target: Record<string, T>): void {
...
export function loadCommands(baseDir: string, logger: ILogger): LoadedCommands {
    ...
    loadCommandsFromDir<ICommand>(path.join(baseDir, "commands"), commands);
    loadCommandsFromDir<ICommand>(path.join(baseDir, "commands/listers"), commands);
    loadCommandsFromDir<ICommand>(path.join(baseDir, "commands/admincommands"), admincommands);
    loadCommandsFromDir<IClCommand>(path.join(baseDir, "commands/clcommands"), clcommands);
    loadCommandsFromDir<ICommand>(path.join(baseDir, "commands/dmcommands"), dmcommands);
